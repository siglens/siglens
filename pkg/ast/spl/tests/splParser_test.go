...
func Test_searchFieldEqualToQuotedString(t *testing.T) {
	...
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
...
func Test_searchFieldNotEqualToQuotedString(t *testing.T) {
	...
	expressionFilter := extractExpressionFilter(t, filterNode)
	assert.Equal(t, "status", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.NotEquals, expressionFilter.FilterOperator)
	assert.Equal(t, "ok", expressionFilter.RightInput.Expression.LeftInput.ColumnValue.StringVal)
}
...
func Test_searchInteger(t *testing.T) {
	...
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("123"), 0 /* qid */)
	assert.Nil(t, err)
...
func Test_searchIntegerLeadingZeros(t *testing.T) {
	...
	assert.Equal(t, "*", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("00123"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFloat(t *testing.T) {
	...
	assert.Equal(t, "*", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("123.5"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFloatLeadingDecimal(t *testing.T) {
	...
	assert.Equal(t, "*", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number(".375"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFloatLeadingPlusSign(t *testing.T) {
	...
	assert.Equal(t, "*", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("+0.375"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFieldEqualToNumber(t *testing.T) {
	...
	assert.Equal(t, "status", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.Equals, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("400"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFieldLessThanNumber(t *testing.T) {
	...
	assert.Equal(t, segutils.LessThan, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("1000"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFieldLessThanOrEqualToNumber(t *testing.T) {
	...
	expressionFilter := extractExpressionFilter(t, filterNode)
	assert.Equal(t, "latency", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.LessThanOrEqualTo, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("0.5"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFieldGreaterThanNumber(t *testing.T) {
	...
	expressionFilter := extractExpressionFilter(t, filterNode)
	assert.Equal(t, "latency", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.GreaterThan, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("3.175"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchFieldGreaterThanOrEqualToNumber(t *testing.T) {
	...
	expressionFilter := extractExpressionFilter(t, filterNode)
	assert.Equal(t, "latency", expressionFilter.LeftInput.Expression.LeftInput.ColumnName)
	assert.Equal(t, segutils.GreaterThanOrEqualTo, expressionFilter.FilterOperator)
	dtype, err := segutils.CreateDtypeEnclosure(json.Number("1200"), 0 /* qid */)
	assert.Nil(t, err)
	assert.Equal(t, dtype, expressionFilter.RightInput.Expression.LeftInput.ColumnValue)
}
...
func Test_searchSimpleAND(t *testing.T) {
	...
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.LessThan)
...
func Test_searchChainedAND(t *testing.T) {
	...
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].AndFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_searchSimpleOR(t *testing.T) {
	...
	assert.Equal(t, astNode.OrFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, astNode.OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.LessThan)
...
func Test_searchChainedOR(t *testing.T) {
	...
	assert.Equal(t, astNode.OrFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, astNode.OrFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_searchANDThenOR(t *testing.T) {
	...
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_searchParenthesesToChangePrecedence(t *testing.T) {
	...
	assert.Equal(t, astNode.OrFilterCondition.NestedNodes[0].AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, astNode.OrFilterCondition.NestedNodes[0].AndFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_searchSimpleNOTEquals(t *testing.T) {
	...
	assert.Len(t, astNode.AndFilterCondition.FilterCriteria, 1)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "status")
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.NotEquals)
...
func Test_searchSimpleNOTLessThan(t *testing.T) {
	...
	assert.Len(t, astNode.AndFilterCondition.FilterCriteria, 1)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "status")
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.GreaterThanOrEqualTo)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(200))
}
...
func Test_searchSimpleNOTGreaterThan(t *testing.T) {
	...
	assert.Len(t, astNode.AndFilterCondition.FilterCriteria, 1)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "status")
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.LessThanOrEqualTo)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(200))
}
...
func Test_searchSimpleNOTLessThanOrEqual(t *testing.T) {
	...
	assert.Len(t, astNode.AndFilterCondition.FilterCriteria, 1)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "status")
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.GreaterThan)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(200))
}
...
func Test_searchSimpleNOTGreaterThanOrEqual(t *testing.T) {
	...
	assert.Len(t, astNode.AndFilterCondition.FilterCriteria, 1)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "status")
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.LessThan)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(200))
}
...
func Test_searchCompoundNOT(t *testing.T) {
	...
	assert.Len(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria, 2)
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "A")
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.LessThanOrEqualTo)
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(1))
	...
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.GreaterThanOrEqualTo)
...
func Test_chainedSearch(t *testing.T) {
	...
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_manyChainedSearch(t *testing.T) {
	...
	assert.Equal(t, andFilter.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, andFilter.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_manyChainedCompoundSearch(t *testing.T) {
	...
	assert.Equal(t, andFilter.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.Equals)
	...
	assert.Equal(t, andFilter.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_regexSingleColumnNotEquals(t *testing.T) {
	...
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(1))
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[1].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "B")
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.NotEquals)
	assert.Equal(t, astNode.AndFilterCondition.FilterCriteria[1].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.StringVal, `^\d$`)
...
func Test_aggCountWithoutField(t *testing.T) {
	...
	assert.Equal(t, pipeCommands.MeasureOperations[0].MeasureFunc, segutils.Count)
	...
	assert.Equal(t, aggregator.MeasureOperations[0].MeasureFunc, segutils.Count)
}
...
func Test_aggDistinctCount(t *testing.T) {
	...
	assert.Len(t, pipeCommands.MeasureOperations, 1)
	assert.Equal(t, pipeCommands.MeasureOperations[0].MeasureCol, "city")
	assert.Equal(t, pipeCommands.MeasureOperations[0].MeasureFunc, segutils.Cardinality)
	...
	assert.Len(t, aggregator.MeasureOperations, 1)
	assert.Equal(t, aggregator.MeasureOperations[0].MeasureCol, "city")
	assert.Equal(t, aggregator.MeasureOperations[0].MeasureFunc, segutils.Cardinality)
}
...
func Test_groupbyOneField(t *testing.T) {
	...
	assert.Equal(t, pipeCommands.GroupByRequest.MeasureOperations[0].MeasureFunc, segutils.Avg)
	...
	assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[0].MeasureFunc, segutils.Avg)
...
func Test_timechartHasGroupby(t *testing.T) {
	...
	for _, queryStr := range queries {
		...
		assert.Equal(t, pipeCommands.GroupByRequest.MeasureOperations[1].MeasureFunc, segutils.Sum)
		assert.Len(t, pipeCommands.GroupByRequest.GroupByColumns, 1)
		...
		assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[1].MeasureFunc, segutils.Sum)
		assert.Len(t, aggregator.GroupByRequest.GroupByColumns, 1)
...
func Test_timechartWithoutGroupby(t *testing.T) {
	...
	for _, queryStr := range queries {
		...
		assert.Len(t, pipeCommands.GroupByRequest.MeasureOperations, 2)
		assert.Equal(t, pipeCommands.GroupByRequest.MeasureOperations[0].MeasureCol, "latency")
		assert.Equal(t, pipeCommands.GroupByRequest.MeasureOperations[0].MeasureFunc, segutils.Min)
		assert.Equal(t, pipeCommands.GroupByRequest.MeasureOperations[1].MeasureCol, "longitude")
		assert.Equal(t, pipeCommands.GroupByRequest.MeasureOperations[1].MeasureFunc, segutils.Range)
		assert.Len(t, pipeCommands.GroupByRequest.GroupByColumns, 1)
		assert.Equal(t, pipeCommands.GroupByRequest.GroupByColumns[0], "timestamp")
		assert.Equal(t, pipeCommands.BucketLimit, segquery.MAX_GRP_BUCKS)
		// Timechart
		...
		assert.Len(t, aggregator.GroupByRequest.MeasureOperations, 2)
		assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[0].MeasureCol, "latency")
		assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[0].MeasureFunc, segutils.Min)
		assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[1].MeasureCol, "longitude")
		assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[1].MeasureFunc, segutils.Range)
		assert.Len(t, aggregator.GroupByRequest.GroupByColumns, 1)
		assert.Equal(t, aggregator.GroupByRequest.GroupByColumns[0], "timestamp")
		assert.Equal(t, aggregator.BucketLimit, segquery.MAX_GRP_BUCKS)
		// Timechart
...
func Test_LogHistogramIntervalCalculation(t *testing.T) {
	...
	assert.Equal(t, segutils.TimeUnit(segutils.TMMinute), aggregator.TimeHistogram.Timechart.BinOptions.SpanOptions.SpanLength.TimeScalr)
...
func Test_aggHasEvalFuncWithoutGroupBy(t *testing.T) {
	...
	assert.Equal(t, segutils.Max, pipeCommands.MeasureOperations[0].MeasureFunc)

	assert.Equal(t, "range(eval(latitude >= 0))", pipeCommands.MeasureOperations[1].StrEnc)
	assert.Equal(t, segutils.Range, pipeCommands.MeasureOperations[1].MeasureFunc)
...
func Test_aggHasEvalFuncWithGroupBy(t *testing.T) {
	...
	assert.Equal(t, segutils.Count, pipeCommands.GroupByRequest.MeasureOperations[0].MeasureFunc)
	...
	assert.Equal(t, segutils.Values, pipeCommands.GroupByRequest.MeasureOperations[1].MeasureFunc)
...
func Test_commentInMiddle(t *testing.T) {
	...
	assert.Equal(t, astNode.OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.Equals)
...
func Test_renameOneAggField(t *testing.T) {
	...
	assert.Equal(t, aggregator.MeasureOperations[0].MeasureFunc, segutils.Avg)
...
func Test_renameManyAggFields(t *testing.T) {
	...
	assert.Equal(t, aggregator.MeasureOperations[1].MeasureFunc, segutils.Count)
	assert.Equal(t, aggregator.MeasureOperations[2].MeasureCol, "latency")
	assert.Equal(t, aggregator.MeasureOperations[2].MeasureFunc, segutils.Min)
...
func Test_renameFieldsWithGroupby(t *testing.T) {
	...
	assert.Equal(t, aggregator.GroupByRequest.MeasureOperations[1].MeasureFunc, segutils.Count)
...
func Test_evalFunctionsRelativeTime(t *testing.T) {
	...
	assert.Equal(t, aggregator.Next.Next.OutputTransforms.LetColumns.ValueColRequest.NumericExpr.RelativeTime.TimeUnit, segutils.TMDay)
	assert.Equal(t, aggregator.Next.Next.OutputTransforms.LetColumns.ValueColRequest.NumericExpr.RelativeTime.Snap, fmt.Sprintf("%d", segutils.TMDay))
}
...
func Test_CalculateRelativeTime_2(t *testing.T) {
	...
	tm := ast.TimeModifier{
		RelativeTime: ast.RelativeTimeModifier{
			...
			Snap: strconv.Itoa(int(segutils.TMHour)),
		},
	}
	epoch, err := spl.CalculateRelativeTime(tm, currTime)
	assert.Nil(t, err)
...
func Test_CalculateRelativeTime_6(t *testing.T) {
	...
	tm := ast.TimeModifier{
		RelativeTime: ast.RelativeTimeModifier{
			...
			Snap: strconv.Itoa(int(segutils.TMMinute)),
		},
	}
	epoch, err := spl.CalculateRelativeTime(tm, currTime)
	assert.Nil(t, err)
...
func Test_CalculateRelativeTime_7(t *testing.T) {
	...
	tm := ast.TimeModifier{
		RelativeTime: ast.RelativeTimeModifier{
			...
			Snap: strconv.Itoa(int(segutils.TMYear)),
		},
	}
	epoch, err := spl.CalculateRelativeTime(tm, currTime)
	assert.Nil(t, err)
...
func Test_CalculateRelativeTime_8(t *testing.T) {
	...
	tm := ast.TimeModifier{
		RelativeTime: ast.RelativeTimeModifier{
			Snap: strconv.Itoa(int(segutils.TMQuarter)),
		},
	}
	epoch, err := spl.CalculateRelativeTime(tm, currTime)
	assert.Nil(t, err)
...
func Test_CalculateRelativeTime_9(t *testing.T) {
	...
	tm := ast.TimeModifier{
		RelativeTime: ast.RelativeTimeModifier{
			RelativeTimeOffset: ast.RelativeTimeOffset{
				Offset:   -1,
				TimeUnit: segutils.TMWeek,
			},
			Snap: strconv.Itoa(int(segutils.TMMonth)),
		},
	}
	epoch, err := spl.CalculateRelativeTime(tm, currTime)
	assert.Nil(t, err)
...
func Test_Bin(t *testing.T) {
	...
	assert.Equal(t, segutils.TMHour, aggregator.OutputTransforms.LetColumns.BinRequest.BinSpanOptions.BinSpanLength.TimeScale)
...
func Test_Bin2(t *testing.T) {
	...
	assert.Equal(t, segutils.TMMonth, aggregator.OutputTransforms.LetColumns.BinRequest.MinSpan.TimeScale)
...
func Test_Bin7(t *testing.T) {
	...
	assert.Equal(t, segutils.TMInvalid, aggregator.OutputTransforms.LetColumns.BinRequest.BinSpanOptions.BinSpanLength.TimeScale)
...
func Test_Bin22(t *testing.T) {
	...
	assert.Equal(t, segutils.TMDecisecond, aggregator.OutputTransforms.LetColumns.BinRequest.BinSpanOptions.BinSpanLength.TimeScale)
...
func Test_Bin23(t *testing.T) {
	...
	assert.Equal(t, segutils.TMCentisecond, aggregator.OutputTransforms.LetColumns.BinRequest.BinSpanOptions.BinSpanLength.TimeScale)
...
func Test_StreamStats(t *testing.T) {
	...
	assert.Equal(t, segutils.TMHour, aggregator.StreamStatsOptions.TimeWindow.TimeScale)
	...
	assert.Equal(t, segutils.Count, aggregator.MeasureOperations[0].MeasureFunc)
...
func Test_StreamStats_2(t *testing.T) {
	...
	assert.Equal(t, segutils.TMSecond, aggregator.StreamStatsOptions.TimeWindow.TimeScale)
	assert.Nil(t, aggregator.StreamStatsOptions.ResetAfter)
	assert.Nil(t, aggregator.StreamStatsOptions.ResetBefore)
	...
	assert.Equal(t, segutils.Count, aggregator.MeasureOperations[0].MeasureFunc)
	assert.Equal(t, "*", aggregator.MeasureOperations[0].MeasureCol)
	assert.Equal(t, segutils.Median, aggregator.MeasureOperations[1].MeasureFunc)
	assert.Equal(t, "sale_amount", aggregator.MeasureOperations[1].MeasureCol)
	assert.Equal(t, segutils.Stdev, aggregator.MeasureOperations[2].MeasureFunc)
	assert.Equal(t, "revenue", aggregator.MeasureOperations[2].MeasureCol)
	assert.Equal(t, segutils.Range, aggregator.MeasureOperations[3].MeasureFunc)
	assert.Equal(t, "price", aggregator.MeasureOperations[3].MeasureCol)
	assert.Equal(t, segutils.Mode, aggregator.MeasureOperations[4].MeasureFunc)
...
func Test_StreamStats_3(t *testing.T) {
	...
	assert.NotNil(t, aggregator.MeasureOperations)
	assert.Equal(t, 1, len(aggregator.MeasureOperations))
	assert.Equal(t, segutils.Max, aggregator.MeasureOperations[0].MeasureFunc)
...
func Test_StreamStats_4(t *testing.T) {
	...
	assert.NotNil(t, aggregator.MeasureOperations)
	assert.Equal(t, 1, len(aggregator.MeasureOperations))
	assert.Equal(t, segutils.Median, aggregator.MeasureOperations[0].MeasureFunc)
	assert.Equal(t, "abc", aggregator.MeasureOperations[0].MeasureCol)
...
func Test_StreamStats_5(t *testing.T) {
	...
	assert.NotNil(t, aggregator.StreamStatsOptions.TimeWindow)
	assert.Equal(t, float64(1), aggregator.StreamStatsOptions.TimeWindow.Num)
	assert.Equal(t, segutils.TMQuarter, aggregator.StreamStatsOptions.TimeWindow.TimeScale)
	assert.Nil(t, aggregator.StreamStatsOptions.ResetBefore)

	assert.Nil(t, aggregator.MeasureOperations)
	assert.NotNil(t, aggregator.GroupByRequest)
	assert.Equal(t, 3, len(aggregator.GroupByRequest.MeasureOperations))
	assert.Equal(t, segutils.Count, aggregator.GroupByRequest.MeasureOperations[0].MeasureFunc)
	assert.Equal(t, "*", aggregator.GroupByRequest.MeasureOperations[0].MeasureCol)
	assert.Equal(t, segutils.Sum, aggregator.GroupByRequest.MeasureOperations[1].MeasureFunc)
	assert.Equal(t, "latency", aggregator.GroupByRequest.MeasureOperations[1].MeasureCol)
	assert.Equal(t, segutils.Min, aggregator.GroupByRequest.MeasureOperations[2].MeasureFunc)
...
func Test_StreamStats_11(t *testing.T) {
	...
	assert.Equal(t, segutils.Count, aggregator.GroupByRequest.MeasureOperations[0].MeasureFunc)
	assert.Equal(t, "*", aggregator.GroupByRequest.MeasureOperations[0].MeasureCol)
	assert.Equal(t, segutils.Cardinality, aggregator.GroupByRequest.MeasureOperations[1].MeasureFunc)
	assert.Equal(t, "user", aggregator.GroupByRequest.MeasureOperations[1].MeasureCol)
	assert.Equal(t, segutils.Avg, aggregator.GroupByRequest.MeasureOperations[2].MeasureFunc)
	assert.Equal(t, "response_time", aggregator.GroupByRequest.MeasureOperations[2].MeasureCol)
	assert.Equal(t, segutils.Max, aggregator.GroupByRequest.MeasureOperations[3].MeasureFunc)
	assert.Equal(t, "response_time", aggregator.GroupByRequest.MeasureOperations[3].MeasureCol)
	assert.Equal(t, segutils.Min, aggregator.GroupByRequest.MeasureOperations[4].MeasureFunc)
	assert.Equal(t, "response_time", aggregator.GroupByRequest.MeasureOperations[4].MeasureCol)
	assert.Equal(t, segutils.Sum, aggregator.GroupByRequest.MeasureOperations[5].MeasureFunc)
...
func Test_StreamStats_16(t *testing.T) {
	...
	assert.Equal(t, segutils.TMYear, aggregator.StreamStatsOptions.TimeWindow.TimeScale)
	assert.Nil(t, aggregator.StreamStatsOptions.ResetAfter)
	assert.Nil(t, aggregator.StreamStatsOptions.ResetBefore)
	assert.Nil(t, aggregator.GroupByRequest)
	...
	assert.Equal(t, segutils.Count, aggregator.MeasureOperations[0].MeasureFunc)
	assert.Equal(t, "*", aggregator.MeasureOperations[0].MeasureCol)
	assert.Equal(t, segutils.Max, aggregator.MeasureOperations[1].MeasureFunc)
	assert.Equal(t, "abc", aggregator.MeasureOperations[1].MeasureCol)
	assert.Equal(t, segutils.Avg, aggregator.MeasureOperations[2].MeasureFunc)
...
func getMeasureFuncStr(measureFunc segutils.AggregateFunctions) (string, string) {
	switch measureFunc {
	case segutils.Cardinality:
		return "dc", ""
	case segutils.Perc, segutils.ExactPerc, segutils.UpperPerc:
...
func testSingleAggregateFunction(t *testing.T, aggFunc segutils.AggregateFunctions) {
...
func performCommon_aggEval_BoolExpr(t *testing.T, measureFunc segutils.AggregateFunctions) {
...
func performCommon_aggEval_Constant_Field(t *testing.T, measureFunc segutils.AggregateFunctions, isField bool) {
...
func performCommon_aggEval_ConditionalExpr(t *testing.T, measureFunc segutils.AggregateFunctions) {
	...
	assert.Equal(t, segutils.Sum, pipeCommands.MeasureOperations[0].MeasureFunc)
...
func getAggFunctions() []segutils.AggregateFunctions {
	return []segutils.AggregateFunctions{segutils.Count, segutils.Sum, segutils.Avg, segutils.Min, segutils.Max,
		segutils.Range, segutils.Cardinality, segutils.Values, segutils.List,
		segutils.Estdc, segutils.EstdcError, segutils.Median,
		segutils.Mode, segutils.Stdev, segutils.Stdevp, segutils.Sumsq, segutils.Var,
		segutils.Varp, segutils.First, segutils.Last, segutils.Earliest, segutils.Latest,
		segutils.EarliestTime, segutils.LatestTime, segutils.StatsRate,
		segutils.Perc, segutils.ExactPerc, segutils.UpperPerc,
	}
}
...
func getTimeAfterOffsetAndSnapDay(t *testing.T, offset int, currTime time.Time) (uint64, error) {
	...
	currTime, err = segutils.ApplyOffsetToTime(int64(offset), segutils.TMDay, currTime)
	if err != nil {
		return uint64(0), err
	}

	snapStr := fmt.Sprintf("%v", segutils.TMDay)
	currTime, err = segutils.ApplySnap(snapStr, currTime)
	if err != nil {
		return uint64(0), err
	}
...
func Test_GenTimes(t *testing.T) {
	...
	assert.Equal(t, segutils.TMDay, aggregator.GenerateEvent.GenTimes.Interval.TimeScalr)
}
...
func Test_GenTimes_3(t *testing.T) {
	...
	expectedStartTime, err := segutils.ConvertCustomDateTimeFormatToEpochMs("10/01/2022:00:00:00")
	assert.Nil(t, err)
	assert.Equal(t, uint64(expectedStartTime), aggregator.GenerateEvent.GenTimes.StartTime)

	expectedEndTime, err := segutils.ConvertCustomDateTimeFormatToEpochMs("12/03/2023:12:20:56")
	assert.Nil(t, err)
...
func Test_GenTimes_4(t *testing.T) {
	...
	assert.Equal(t, segutils.TMMinute, aggregator.GenerateEvent.GenTimes.Interval.TimeScalr)
}
...
func Test_GenTimes_5(t *testing.T) {
	...
	expectedStartTime, err := segutils.ConvertCustomDateTimeFormatToEpochMs("12/03/2023:23:11:56")
	assert.Nil(t, err)
	assert.Equal(t, uint64(expectedStartTime), aggregator.GenerateEvent.GenTimes.StartTime)
	...
	assert.Equal(t, segutils.TMHour, aggregator.GenerateEvent.GenTimes.Interval.TimeScalr)
}
...
func Test_GenTimes_8(t *testing.T) {
	...
	assert.Equal(t, segutils.TMSecond, aggregator.GenerateEvent.GenTimes.Interval.TimeScalr)
}
...
func Test_Index(t *testing.T) {
	...
	boolNode, aggregator, indexNames, err := pipesearch.ParseQuery(query, 0, "Splunk QL")
	assert.Nil(t, err)
	assert.NotNil(t, boolNode)
	assert.Nil(t, aggregator)
	assert.ElementsMatch(t, []string{"main"}, indexNames)
}
...
func Test_Index_2(t *testing.T) {
	...
	assert.NotNil(t, boolNode)
	assert.Nil(t, aggregator)
	assert.ElementsMatch(t, []string{"main", "dual", "dummy"}, indexNames)
}
...
func Test_Index_4(t *testing.T) {
	...
	assert.ElementsMatch(t, []string{"main", "dummy", "dual"}, queryStruct.IndexNames)
...
func Test_Index_5(t *testing.T) {
	...
	queryStruct := res.(ast.QueryStruct)
	filterNode := queryStruct.SearchFilter
	assert.ElementsMatch(t, []string{"main", "dual"}, queryStruct.IndexNames)
	...
	assert.Len(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria, 2)
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "A")
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.FilterOperator, segutils.GreaterThanOrEqualTo)
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[0].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(1))
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.LeftInput.Expression.LeftInput.ColumnName, "B")
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.FilterOperator, segutils.LessThan)
	assert.Equal(t, astNode.AndFilterCondition.NestedNodes[0].OrFilterCondition.FilterCriteria[1].ExpressionFilter.RightInput.Expression.LeftInput.ColumnValue.UnsignedVal, uint64(2))
}
...
func Test_Index_6(t *testing.T) {
	...
	assert.NotNil(t, astNode)
	assert.NotNil(t, aggregator)
	assert.ElementsMatch(t, []string{"abc", "d*"}, indexNames)
