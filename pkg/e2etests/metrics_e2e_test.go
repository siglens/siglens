...
func Test_SimpleMetricInstantQuery(t *testing.T) {
	...
	// Now since this is more than the DEFAULT_LOOKBACK_FOR_INSTANT_VECTOR(5m), the query will not return any results.
	endTime = startTimestamp + 3600 + uint32(structs.DEFAULT_LOOKBACK_FOR_INSTANT_VECTOR.Seconds()) + 1
