...
func Test_Head_Expr_Basic(t *testing.T) {
	knownValues := map[string][]segutils.CValueEnclosure{
		"gender": {
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "female"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
		},
		"ident": {
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "a"},
...
func Test_Head_Expr_Null(t *testing.T) {
	knownValues := map[string][]segutils.CValueEnclosure{
		"gender": {
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_BACKFILL, CVal: nil},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "female"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "male"},
		},
...
func Test_Head_Expr_Multiple(t *testing.T) {
	knownValues := map[string][]segutils.CValueEnclosure{
		...
		"ident": {
			...
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "g"},
			segutils.CValueEnclosure{Dtype: segutils.SS_DT_STRING, CVal: "h"},
		},
	}
	iqr1 := iqr.NewIQR(0)
	err := iqr1.AppendKnownValues(knownValues)
