...
func filterViaMicroIndices(currQuery *structs.SearchQuery, indexNames []string, timeRange *dtu.TimeRange,
	...
	rangeFilter map[string]string, rangeOp sutils.FilterOperator, wildCardValue bool,
...
func getAllSearchRequestsFromCmi(currQuery *structs.SearchQuery, timeRange *dtu.TimeRange,
	segkeysToCheck map[string]map[string]*BlockTracker, bloomKeys map[string]bool, originalBloomKeys map[string]string, bloomOp sutils.LogicalOperator,
	rangeFilter map[string]string, rangeOp sutils.FilterOperator, isRange bool, wildCardValue bool,
