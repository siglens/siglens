...
func Test_NumericExpr_Sigfig(t *testing.T) {
	...
	testCases := []TestCase{
		{
			EquationString: "sigfig(2.34 + 1.2)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left:  &NumericExpr{IsTerminal: true, Value: "2.34"},
					Right: &NumericExpr{IsTerminal: true, Value: "1.2"},
				},
				Right: nil,
			},
			ExpectedAnswer: 3.5,
		...
		{
			EquationString: "sigfig(5.00 + 1.234)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left:  &NumericExpr{IsTerminal: true, Value: "5.00"},
					Right: &NumericExpr{IsTerminal: true, Value: "1.234"},
				},
				Right: nil,
			},
			ExpectedAnswer: 6.23,
		...
		{
			EquationString: "sigfig(123 + 4.56)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left:  &NumericExpr{IsTerminal: true, Value: "123"},
					Right: &NumericExpr{IsTerminal: true, Value: "4.56"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(0.1234 - 0.005)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "-",
					Left:  &NumericExpr{IsTerminal: true, Value: "0.1234"},
					Right: &NumericExpr{IsTerminal: true, Value: "0.005"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(3.1 + 0.004 + 12.55)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left: &NumericExpr{
						IsTerminal: false, Op: "+",
						Left:  &NumericExpr{IsTerminal: true, Value: "3.1"},
						Right: &NumericExpr{IsTerminal: true, Value: "0.004"},
					},
					Right: &NumericExpr{IsTerminal: true, Value: "12.55"},
				},
				Right: nil,
			},
			ExpectedAnswer: 15.7,
		...
		{
			EquationString: "sigfig(2.5 * 1.23)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "*",
					Left:  &NumericExpr{IsTerminal: true, Value: "2.5"},
					Right: &NumericExpr{IsTerminal: true, Value: "1.23"},
				},
				Right: nil,
			},
			ExpectedAnswer: 3.1,
		...
		{
			EquationString: "sigfig(0.0045 * 12.3)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "*",
					Left:  &NumericExpr{IsTerminal: true, Value: "0.0045"},
					Right: &NumericExpr{IsTerminal: true, Value: "12.3"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(3.00 * 1.2)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "*",
					Left:  &NumericExpr{IsTerminal: true, Value: "3.00"},
					Right: &NumericExpr{IsTerminal: true, Value: "1.2"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(0.078 / 1.23)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "/",
					Left:  &NumericExpr{IsTerminal: true, Value: "0.078"},
					Right: &NumericExpr{IsTerminal: true, Value: "1.23"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig((2.3 + 0.12) * 1.5)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "*",
					Left: &NumericExpr{
						IsTerminal: false, Op: "+",
						Left:  &NumericExpr{IsTerminal: true, Value: "2.3"},
						Right: &NumericExpr{IsTerminal: true, Value: "0.12"},
					},
					Right: &NumericExpr{IsTerminal: true, Value: "1.5"},
				},
				Right: nil,
			},
			ExpectedAnswer: 3.6,
		...
		{
			EquationString: "sigfig((1.23 * 0.5) + 3.456)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left: &NumericExpr{
						IsTerminal: false, Op: "*",
						Left:  &NumericExpr{IsTerminal: true, Value: "1.23"},
						Right: &NumericExpr{IsTerminal: true, Value: "0.5"},
					},
					Right: &NumericExpr{IsTerminal: true, Value: "3.456"},
				},
				Right: nil,
			},
			ExpectedAnswer: 4.1,
		...
		{
			EquationString: "sigfig((0.0012 + 0.034) / 5.6)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "/",
					Left: &NumericExpr{
						IsTerminal: false, Op: "+",
						Left:  &NumericExpr{IsTerminal: true, Value: "0.0012"},
						Right: &NumericExpr{IsTerminal: true, Value: "0.034"},
					},
					Right: &NumericExpr{IsTerminal: true, Value: "5.6"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(((4.50 - 2.1) * 3.0) + 0.005)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left: &NumericExpr{
						...
						Left: &NumericExpr{
							IsTerminal: false, Op: "-",
							Left:  &NumericExpr{IsTerminal: true, Value: "4.50"},
							Right: &NumericExpr{IsTerminal: true, Value: "2.1"},
						},
						Right: &NumericExpr{IsTerminal: true, Value: "3.0"},
					},
					Right: &NumericExpr{IsTerminal: true, Value: "0.005"},
				},
				Right: nil,
		...
		{
			EquationString: "sigfig((5.123 - 5.120) * 123.45)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "*",
					Left: &NumericExpr{
						IsTerminal: false, Op: "-",
						Left:  &NumericExpr{IsTerminal: true, Value: "5.123"},
						Right: &NumericExpr{IsTerminal: true, Value: "5.120"},
					},
					Right: &NumericExpr{IsTerminal: true, Value: "123.45"},
				},
				Right: nil,
			},
			ExpectedAnswer: 0.4,
		...
		{
			EquationString: "sigfig(1200 / 3.0)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "/",
					Left:  &NumericExpr{IsTerminal: true, Value: "1200"},
					Right: &NumericExpr{IsTerminal: true, Value: "3.0"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(12345.67 + 0.000001)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left:  &NumericExpr{IsTerminal: true, Value: "12345.67"},
					Right: &NumericExpr{IsTerminal: true, Value: "0.000001"},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(2.0 + 3.0 * 4.0)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
					Left: &NumericExpr{IsTerminal: true, Value: "2.0"},
					Right: &NumericExpr{
						IsTerminal: false, Op: "*",
						Left:  &NumericExpr{IsTerminal: true, Value: "3.0"},
						Right: &NumericExpr{IsTerminal: true, Value: "4.0"},
					},
				},
				Right: nil,
			},
		...
		{
			EquationString: "sigfig(2.0 + 4.0 + 3.0)",
			Expression: NumericExpr{
				IsTerminal: false, Op: "sigfig",
				Left: &NumericExpr{
					IsTerminal: false, Op: "+",
	...
	for _, tc := range testCases {
		fieldToValue := make(map[string]sutils.CValueEnclosure)
		res, err := tc.Expression.Evaluate(fieldToValue)
		if err == nil {
			assert.Equal(t, tc.ExpectedAnswer, res)
		}
	}
}
