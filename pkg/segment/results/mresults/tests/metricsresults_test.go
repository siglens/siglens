...
func Test_GetResults_AggFn_Sum(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Sum, Without: true}
	mQuery := &structs.MetricsQuery{
		...
		Downsampler: structs.Downsampler{
			...
			Unit:       "h",
			CFlag:      false,
			Aggregator: structs.Aggregation{AggregatorFunction: sutils.Sum},
		},
...
func Test_GetResults_AggFn_Avg(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Avg, Without: true}
	mQuery := &structs.MetricsQuery{
		MetricName:      "test.metric.0",
		FirstAggregator: aggregator,
		Downsampler: structs.Downsampler{
...
func Test_GetResults_AggFn_Count(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Count, Without: true}
...
func Test_GetResults_AggFn_Group(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Group, Without: true}
	metricName := "test.metric.1"
	downsampler := structs.Downsampler{
		Interval:   1,
		Unit:       "h",
...
func Test_GetResults_AggFn_Stdvar(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Stdvar, Without: true}
	metricName := "test.metric.1"
	downsampler := structs.Downsampler{
		Interval:   1,
		Unit:       "h",
...
func Test_GetResults_AggFn_Stddev(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Stddev, Without: true}
	metricName := "test.metric.1"
	downsampler := structs.Downsampler{
		Interval:   1,
		Unit:       "h",
...
func Test_GetResults_AggFn_Quantile(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Quantile, FuncConstant: 0.5, Without: true}
	mQuery := &structs.MetricsQuery{
		MetricName:      "test.metric.0",
		FirstAggregator: aggregator,
		Downsampler: structs.Downsampler{
...
func Test_GetResults_AggFn_QuantileFloatIndex(t *testing.T) {
	aggregator := structs.Aggregation{AggregatorFunction: sutils.Quantile, FuncConstant: 0.3, Without: true}
	mQuery := &structs.MetricsQuery{
		MetricName:      "test.metric.0",
		FirstAggregator: aggregator,
		Downsampler: structs.Downsampler{
...
func Test_GetResults_AggFn_TopK(t *testing.T) {
	...
	aggregator := structs.Aggregation{AggregatorFunction: sutils.TopK, FuncConstant: 2.0, Without: true}
	metricName := "test.metric.1"
	downsampler := structs.Downsampler{
		Interval:   1,
		Unit:       "h",
...
func Test_GetResults_AggFn_BottomK(t *testing.T) {
	...
	aggregator := structs.Aggregation{AggregatorFunction: sutils.BottomK, FuncConstant: 2.0, Without: true}
	metricName := "test.metric.1"
	downsampler := structs.Downsampler{
		Interval:   1,
		Unit:       "h",
...
func Test_GetResults_Modulo(t *testing.T) {
	test_GetResults_Ops(t,
		...
		structs.Downsampler{
			...
			Unit:       "h",
			CFlag:      false,
			Aggregator: structs.Aggregation{AggregatorFunction: sutils.Avg},
		},
	)
}
		...
		[]structs.QueryArithmetic{
			{
				LHS:        1,
				ConstantOp: true,
				Operation:  sutils.LetGreaterThan,
				Constant:   1045,
			},
		},
		structs.Downsampler{
		...
		[]structs.QueryArithmetic{
			{
				LHS:        1,
				ConstantOp: true,
				Operation:  sutils.LetGreaterThanOrEqualTo,
				Constant:   100,
			},
		},
		structs.Downsampler{
		...
		[]structs.QueryArithmetic{
			{
				LHS:        1,
				ConstantOp: true,
				Operation:  sutils.LetLessThanOrEqualTo,
				Constant:   1045,
			},
		},
		structs.Downsampler{
...
func initialize_Multiple_Metric_Results(t *testing.T, initialEntries1 map[uint32]float64, initialEntries2 map[uint32]float64, labelStrs1 []string, labelStrs2 []string, queryOps []structs.QueryArithmetic, downsampler structs.Downsampler, aggregator structs.Aggregation) map[uint64]*mresults.MetricsResult {
