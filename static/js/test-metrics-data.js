...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        $('#source-options').on('click', '.source-option', function() {
            ...
            var showDataIngestion = ['Vector Metrics', 'Metricbeat', 'Open Telemetry'].includes(selectedLogSource);
            ...
            switch (selectedLogSource) {
                ...
                case 'Open Telemetry':
                    ...
                    $('#setup-instructions-link').attr('href', 'https://www.siglens.com/siglens-docs/metric-ingestion/' + selectedLogSource.toLowerCase().split(' ').join('-'));
                    break;
                case 'Send Test Data':
                    $('#test-data-btn').show();
                    break;
